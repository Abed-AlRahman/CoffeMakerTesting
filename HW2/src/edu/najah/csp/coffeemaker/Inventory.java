...
public class Inventory {
     ...
     * @throws InventoryException
     */
    public synchronized void addSugar(String sugar) throws NumberFormatException, InventoryException {
    	int amtSugar = 0;
    	try {
...
//    		2. throw new InventoryException("Units of sugar must be a positive integer");
		...
		if (amtSugar >= 0) {
//			fixed a logical error where the if statement was checking whether amtSugar if less or equal to zero
